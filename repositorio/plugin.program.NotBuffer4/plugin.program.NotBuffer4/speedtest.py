...
I1IiI = 'plugin.program.NotBuffer4'
...
def i1Ii1i1I11Iii ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 OoO0O00O0oo0O = [ ' ' , ' ' , ' ' ]
 I1i1i1 . create ('[COLOR orange]NotBuffer 4[/COLOR] [COLOR lime]Velocidad de Internet[/COLOR] [COLOR blue](By OOKLA)[/COLOR]' , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR gold][B]Resultados[/COLOR][/B]" ,"[COLOR red]- Menos de 7 Mbps, solo contenido SD [/COLOR]", "[COLOR white]- Entre 10-15Mbps todo el HD deberia verse OK[/COLOR]","[COLOR lime]- Mas de 20Mbps+ es optimo para todo el streaming[/COLOR]" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
