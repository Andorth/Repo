...
iconpath = xbmc.translatePath(os.path.join('special://home/addons/script.mantenimiento','icon.png'))
...
xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('Mantenimiento:',  'Packages: '+ str(total_sizetext) +  ' MB'  ' - Images: ' + str(total_sizetext2) + ' MB' , '5000', iconpath))